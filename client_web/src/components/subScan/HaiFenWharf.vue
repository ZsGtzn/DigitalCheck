 ...
 * localstorage
 */
const ScanHaiFenWharfPersonIdentifierKey = "ScanHaiFenWharfPersonIdentifier";

const saveHaiFenWharfPersonIdentifier = (val) => {
    localStorage.setItem(ScanHaiFenWharfPersonIdentifierKey, val);
}

const getHaiFenWharfPersonIdentifier = () => {
    return localStorage.getItem(ScanHaiFenWharfPersonIdentifierKey) || "";
}
...
export default {
    ...
    data() {
        return {
            identityNo: getHaiFenWharfPersonIdentifier(),
    ...
    methods: {
        search() {
            ...
            //
            saveHaiFenWharfPersonIdentifier(this.identityNo);

            //
            if (this.checkPersonIdentifier(this.identityNo)) {
                this.$router.push({
                    path: `/invoiceList/haiFenWharf/${this.identityNo}`
                });
            }
        }
    }
